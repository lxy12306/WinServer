...
CServiceCtrlDlg::CServiceCtrlDlg(CWnd* pParent /*=NULL*/)
	: CDialogEx(CServiceCtrlDlg::IDD, pParent)
{
...
BEGIN_MESSAGE_MAP(CServiceCtrlDlg, CDialogEx)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
END_MESSAGE_MAP()
...
void CServiceCtrlDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
